...
void leerArchivo(){
    ...
    cin>>nombreArchivo;
     */
    archivo.open("C:\\Users\\leode\\OneDrive\\Escritorio\\Manejo de archivos\\DATA.txt",std::ios::in);
...
void agregarArchivo(){
    fstream archivo;
    archivo.open("C:\\Users\\leode\\OneDrive\\Escritorio\\Manejo de archivos\\DATA.txt",ios::app);
    if (archivo.fail()==true){
        cout<<strerror(errno)<<"\n";
        return ;
    }archivo<<"void virus(){\n"
